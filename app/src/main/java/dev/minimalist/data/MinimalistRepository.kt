...
import dev.minimalist.data.db.AppRuleEntity
import dev.minimalist.data.db.BlackoutWindowEntity
import dev.minimalist.data.db.MinimalistDatabase
import dev.minimalist.data.db.NotificationDigestEntity
import dev.minimalist.data.db.OverrideKind
import dev.minimalist.data.db.OverrideLogEntity
import dev.minimalist.data.db.PendingChangeEntity
import dev.minimalist.data.db.PendingChangeKind
import dev.minimalist.data.db.UsageSessionEntity
import dev.minimalist.data.prayer.PrayerRepository
import dev.minimalist.data.settings.AppSettings
import dev.minimalist.data.settings.SettingsStore
import dev.minimalist.domain.AppRuleSnapshot
import dev.minimalist.domain.AppTier
import dev.minimalist.domain.AppUsageToday
import dev.minimalist.domain.BlackoutSchedule
import dev.minimalist.domain.BlackoutWindowSpec
import dev.minimalist.domain.BudgetCalculator
import dev.minimalist.domain.GateDecision
import dev.minimalist.domain.GateEvaluator
...
class MinimalistRepository(
     ...
     * [dev.minimalist.data.RuleMutator] and the pending-change worker may call this.
     */
...
fun AppRuleEntity.toSnapshot(): AppRuleSnapshot = AppRuleSnapshot(
    ...
    label = label,
    tier = tier,
    budget = dev.minimalist.domain.AppBudget(dailyMinutes = dailyMinutes, dailyOpens = dailyOpens),
