package dev.minimalist.data.settings
...
import dev.minimalist.domain.GatePolicy
import dev.minimalist.domain.HighLatitudeRule
import dev.minimalist.domain.Madhab
import dev.minimalist.domain.Prayer
import dev.minimalist.domain.PrayerConfig
import dev.minimalist.domain.PrayerWindowConfig
import dev.minimalist.domain.Tasbih
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.first
import kotlinx.coroutines.flow.map

private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "minimalist_settings")
