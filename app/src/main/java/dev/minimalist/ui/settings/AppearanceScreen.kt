...
import dev.minimalist.data.settings.Language
import dev.minimalist.data.settings.ThemeMode
...
fun AppearanceScreen() {
    ...
    MinimalPage(title = t("Appearance and navigation")) {
            ...
            Language.entries.forEach { language ->
                ...
                Text(
                    ...
                    modifier = Modifier
                        .weight(1f)
                        .clip(MinimalShape)
                        .border(1.dp, if (active) Faint else Fainter, MinimalShape)
                        .noRippleClickable {
                            scope.launch {
