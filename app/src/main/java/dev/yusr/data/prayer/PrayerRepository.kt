package dev.yusr.data.prayer

import android.content.Context
import dev.yusr.data.db.YusrDatabase
import dev.yusr.data.db.PrayerDayEntity
import dev.yusr.data.settings.PrayerSettings
...
class PrayerRepository(
    ...
    private val prayerDays = YusrDatabase.get(context).prayerDayDao()
